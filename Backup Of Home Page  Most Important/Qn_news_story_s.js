...
settit(response.data.Item2.Meta_OG_Title);
      ...
      useEffect(() => {
        ...
        refda();
           ...
           console.log(storyIDd); // Should now correctly log the value of 'storyId'
  ...
  {/* ErrorMessage part */}
  <div id="HiddenErrorDiv" hidden={isVisible2}  >
     <div className='container ' >
<div> <img src="https://menafn.com//includes/img/error-logo-left.png"/>  <div className='SorryStyle'>403</div>
</div>

<div>
<div class="SorryStyle">Sorry!!</div>
             ...
             <div id="RColNewslatter" className="newedge-newsletter classnewletterwidth" >
               ...
               <div className="introtext">
                 ...
                 <p className="footer-info">
                   ...
                   <label>
                     <input type="radio" name="question" defaultValue={0} defaultChecked />
                     Daily(English)
                   </label>
                 </div>
                 <div className="radio">
                   <label>
                     <input type="radio" name="question" defaultValue={1} />
                     Daily(Arabic)
                   </label>
                 </div>
                 <div className="radio">
                   <label>
                     <input type="radio" name="question" defaultValue={2} />
                     All()
                   </label>
                 </div>
                 <p />
               ...
               <div className="form">
                 <input name="ctl00$ContentPlaceHolder1$txt_news_letter" type="text" id="ContentPlaceHolder1_txt_news_letter" placeholder="E-mail" className="form-control" />
                 <br />
                 <a href= {"Qn_news_story_s?StoryId=" + storyID + "&title="+title }    name="ctl00$ContentPlaceHolder1$btn_newsletter"   id="ContentPlaceHolder1_btn_newsletter" className="btn SubscribeBody" >Subscribe</a>
